...
if [ -f "$lsregister" ]; then
    ...
    restartNotification=$(/Library/Application\ Support/JAMF/bin/jamfHelper.app/Contents/MacOS/jamfHelper -windowType utility -description "A computer restart is needed to set Google Chrome as your default browser." -title "Jamf" -heading "Google Chrome set as default browser" -button1 "OK")
else
